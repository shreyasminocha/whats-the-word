...
Original file is located at
    https://colab.research.google.com/drive/1qu6G4bVi3HakCeb-HdEbj_3eIwlibXT4
"""

# BERT Text to Encodings
...
target_word_embeddings = np.empty((sentences_list_len, 768)) # TODO Change the constant
